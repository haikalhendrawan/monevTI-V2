...
export default function LogBookTableToolbar({filterName, onFilterName, onFilterStatus, filterStatus}) {
      ...
      {open && (
        <FormControl sx={{ m: 1, minWidth: 120 }} size="small">
            ...
            <Select 
              ...
              >
                <MenuItem sx={{typography:'body2'}} onClick={(event)=>{event.stopPropagation()}} value={null}>All</MenuItem>
