    ...
    <Grid item xs={12} sm={12} md={12}>
      <Card sx={{backgroundColor:theme.palette.background.paper, pl:1, pt:0}}>
        <Grid container sx={{mt:1, textAlign:'center', justifyContent:'center'}} spacing={0}>  {/* Kepala Table */}
          <Grid item xs={12}>
              <Typography variant="body2" sx={{mr:1}}>Bagian ini berisi sejumlah 14 pertanyaan seputar kondisi pengelolaan TIK di KPPN;</Typography>
              <Typography variant="body2" sx={{mr:1}}>Pengisian kuesioner dibatasi time limit 20 menit;</Typography>
